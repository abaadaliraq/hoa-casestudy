...
export default function ProfitDistribution() {
  ...
  تعكس السيناريوهات أثر كل من متوسط صرف الطاولة ومعدل دورانها على صافي التشغيل.
  فكلما تحسّن الإشغال اليومي وارتفع متوسط الصرف، زادت قدرة المشروع على توليد
  عائد قابل للتوزيع ضمن نموذج مالي أكثر استقرارًا.
</p>
            </div>
